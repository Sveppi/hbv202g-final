...
public class Idioms {
    ...
    protected static final String[] idiomCollection = { 
            ...
            "Langt þykir þeim sem búinn bíðurBregður flestum á banadægri",
            "Nú er Bleik brugðið",
            ...
            "Í dag mér, á morgun þérÖll ævin er dauði",
            ...
            "SárHulin sár eru hættust",
            "Illa gróa gömul sár",
            "SiðurSinn er siður í landi hverju",
    ...
    /**
     * Returns the collection of idioms.
     *
     * @return an array of strings representing the idioms
     */
    public static String[] getIdiomCollection() {
    ...
    /**
     * Returns a random idiom from the collection of idioms.
     *
